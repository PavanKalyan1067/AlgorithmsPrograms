...
namespace AlgorithmPrograms
{
    ...
    {
        static string sentence = "Hello <<name>>, We have your full name as <<Name1>> in our system.your contact number is 91 - xxxxxxxxxx.Please, let us know in case of any clarification Thank you BridgeLabz 01/04/2022.";
        public static void DisplayMessage()
        {
            ...
            if (dateTime.IsMatch("01/04/2022"))
            {
                string date = DateTime.Now.ToString("MM/dd/yyyy");
                sentence = sentence.Replace("01/04/2022", date);
